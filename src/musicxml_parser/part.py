...
class Part(object):
    ...
    def __init__(
        ...
        self.guitarPartsET = guitarPartsET  # input containing guitar tablature ?
        ...
        while current_measure_number < measure_length:
            ...
            if self.expandRepeats:
                if parsed_measure.first_ending_start:
                    if current_measure_number in resolved_first_ending:
                        ending_index = resolved_first_ending.index(
                            current_measure_number
                        )
                        current_measure_number = (
                            end_measure_of_first_ending[ending_index] + 1
                        )
            ...
            if self.expandRepeats:
                ...
                if parsed_measure.repeat == "start":
                    ...
                    parsed_measure.repeat == "jump"
                    and current_measure_number not in resolved_repeats
                ):
